...
int main(void) {
  ...
  tcase_add_test(tc1_1, push_and_pop_list_uint);
  tcase_add_test(tc1_1, push_and_pop_list_double);
  tcase_add_test(tc1_1, pop_from_empty_list);
  tcase_add_test(tc1_1, parse_obj_simple);
  tcase_add_test(tc1_1, parse_obj_incorrect_vertex);
  tcase_add_test(tc1_1, parse_obj_incorrect_face);
